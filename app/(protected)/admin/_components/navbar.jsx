...
export const Navbar = () => {
  ...
  const className = {
     link: 'capitalize m-0 px-3 lg:px-5 py-2 text-sm font-bold dark:text-teal-100  hover:text-black-500 flex items-center rounded-tr-full rounded-br-full gap-2 w-fit min-w-[250px]',
  }
  return (
