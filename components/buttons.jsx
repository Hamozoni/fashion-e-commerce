...
export const ButtonWithIcon = ({
    ...
    const className = {
        flex: 'flex items-center justify-center shadow-lg hover:shadow-none gap-2 font-medium text-sm w-full py-2 px-4 border capitalize rounded-full hover:scale-95',
